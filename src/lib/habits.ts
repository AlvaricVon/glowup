...
export const HABITS: HabitDef[] = [
  ...
  { id: 'subuh-masjid', label: 'Sholat subuh ke masjid', period: 'pagi', priority: 2 },
  ...
  // Sore
  { id: 'ashar-masjid', label: 'Sholat ashar ke masjid', period: 'sore', priority: 10 },
  ...
  // Malam
  { id: 'maghrib-masjid', label: 'Sholat maghrib ke masjid', period: 'malam', priority: 13 },
  { id: 'pushups-maghrib', label: 'Push-ups (10-20x)', description: 'Habis sholat', period: 'malam', priority: 14, days: REST_DAYS },
  { id: 'isya-masjid', label: 'Sholat isya ke masjid', period: 'malam', priority: 15 },
